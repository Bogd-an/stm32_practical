...
Інколи плата не переходить в режим прошивки, тому доводеться ручками.

1. Джампер BOOT0 на 0 та перезавантажуємо кнопкою Reset. Прошиваємо.

2. Після прошивки джампер BOOT0 на 1 та перезавантажуємо кнопкою Reset.
